...
#ifndef RTW_HEADER_helicopter_lab2_h_
#define RTW_HEADER_helicopter_lab2_h_
#include <math.h>
#include <string.h>
#ifndef helicopter_lab2_COMMON_INCLUDES_
#define helicopter_lab2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* helicopter_lab2_COMMON_INCLUDES_ */

#include "helicopter_lab2_types.h"
...
#define helicopter_lab2_rtModel        RT_MODEL_helicopter_lab2_T

/* Block signals (default storage) */
typedef struct {
  real_T TravelCounttorad;             /* '<S4>/Travel: Count to rad' */
  real_T Gain;                         /* '<S12>/Gain' */
  real_T Traveldeg;                    /* '<Root>/Sum5' */
...
#define rtB                            helicopter_lab2_B
#define BlockIO                        B_helicopter_lab2_T
#define rtX                            helicopter_lab2_X
#define ContinuousStates               X_helicopter_lab2_T
#define rtXdot                         helicopter_lab2_XDot
#define StateDerivatives               XDot_helicopter_lab2_T
#define tXdis                          helicopter_lab2_XDis
#define StateDisabled                  XDis_helicopter_lab2_T
#define rtP                            helicopter_lab2_P
#define Parameters                     P_helicopter_lab2_T
#define rtDWork                        helicopter_lab2_DW
#define D_Work                         DW_helicopter_lab2_T

/* Parameters (default storage) */
struct P_helicopter_lab2_T_ {
...
struct tag_RTM_helicopter_lab2_T {
  const char_T *path;
...
extern P_helicopter_lab2_T helicopter_lab2_P;

/* Block signals (default storage) */
extern B_helicopter_lab2_T helicopter_lab2_B;

/* Continuous states (default storage) */
extern X_helicopter_lab2_T helicopter_lab2_X;

/* Block states (default storage) */
extern DW_helicopter_lab2_T helicopter_lab2_DW;

/* Model entry point functions */
extern void helicopter_lab2_initialize(void);
extern void helicopter_lab2_output(void);
extern void helicopter_lab2_update(void);
extern void helicopter_lab2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_lab2_rtModel *helicopter_lab2(void);
...
extern RT_MODEL_helicopter_lab2_T *const helicopter_lab2_M;
 ...
 *
 * '<Root>' : 'helicopter_lab2'
 * '<S1>'   : 'helicopter_lab2/Conversion'
 * '<S2>'   : 'helicopter_lab2/Degrees to Radians'
 * '<S3>'   : 'helicopter_lab2/Elevation controller'
 * '<S4>'   : 'helicopter_lab2/Helicopter_interface'
 * '<S5>'   : 'helicopter_lab2/Pitch controller'
 * '<S6>'   : 'helicopter_lab2/Elevation controller/If Action Subsystem'
 * '<S7>'   : 'helicopter_lab2/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicopter_lab2/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicopter_lab2/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicopter_lab2/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicopter_lab2/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicopter_lab2/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicopter_lab2/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_lab2_h_ */
