  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% helicopter_P.ToHostFile_Decimation
	  section.data(8).logicalSrcIdx = 73;
	  section.data(8).dtTransOffset = 37;
	
	  ;% helicopter_P.ToHostFile_BitRate
	  ...
	  ;% helicopter_P.ToHostFile_file_name
	  section.data(2).logicalSrcIdx = 113;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_P.ToHostFile_VarName
	  section.data(3).logicalSrcIdx = 114;
	  section.data(3).dtTransOffset = 15;
	
	  ;% helicopter_P.ToHostFile_FileFormat
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter_DW.ToHostFile_PointsWritten
	  ...
	  ;% helicopter_DW.ToHostFile_PWORK
	  ...
	  ;% helicopter_DW.ToHostFile_SamplesCount
	  section.data(2).logicalSrcIdx = 37;
	  section.data(2).dtTransOffset = 8;
	
	  ;% helicopter_DW.ToHostFile_ArrayNameLength
  ...
  targMap.checksum0 = 2134635935;
  targMap.checksum1 = 2350190184;
  targMap.checksum2 = 149592618;
  targMap.checksum3 = 501168852;
